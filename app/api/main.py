...
from app.api.routes import users, products, categories, supermarkets, rabbitmq
...
api_router.include_router(rabbitmq.router, prefix="/api/rabbitmq", tags=["rabbitmq"], dependencies=[Depends(validate_api_key)])